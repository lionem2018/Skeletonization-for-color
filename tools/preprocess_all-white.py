...
DEFAULT_ORIGINAL_SKELETON_IMAGE_DIR = os.path.join(SCRIPT_PATH, '../skeleton-image-data/skeleton-images-white-original')
DEFAULT_OTSU_SKELETON_IMAGE_DIR = os.path.join(SCRIPT_PATH, '../skeleton-image-data/skeleton-images-white-otsu-thin')
...
DEFAULT_SKELETON3D_SKELETON_IMAGE_DIR = os.path.join(SCRIPT_PATH, '../skeleton-image-data/skeleton-images-white-otsu-skeleton3d')
